...
function Location({ xPos , yPos , name , givenColor , givenTime  }) {
    const [color, setColor] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(givenColor);
    const [time, setTime] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(givenTime);
    const [tag, setTag] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(name);
